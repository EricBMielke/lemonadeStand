...
namespace lemonadeStand
{
    class Store
    {
        ...
        public static double PurchaseCups(double cupsNeededInt, double totalMoney)
        {
            ...
            Console.WriteLine("At $.04 per cup, you bought " + cupsNeededInt + ". Your running total is $" + currentMoney.ToString("0.00") + ".");
            return currentMoney;
        }
        public static double PurchaseIce(double iceNeededInt, double totalMoney)
        {
            double currentMoney = totalMoney - (iceNeededInt * .05);
            Console.WriteLine("At $.04 per piece of ice, you bought " + iceNeededInt + ". Your running total is $" + currentMoney.ToString("0.00") + ".");
            return currentMoney;
        }
        public static double PurchaseSugar(double sugarNeededInt, double totalMoney)
        {
            ...
            Console.WriteLine("At $.04 per gram of sugar, you bought " + sugarNeededInt + ". Your running total is $" + currentMoney.ToString("0.00") + ".");
            return currentMoney;
        }
    }
}
